def srtf(arrival_time, burst_time, number_of_processes):
...
if __name__ == "__main__":
  ...
  completion_times, turn_around_times, waiting_times, average_waiting_time,average_tat = srtf(arrival_time, burst_time, number_of_processes)
